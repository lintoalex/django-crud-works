...
urlpatterns = [
    ...
    path("employee/<int:pk>",views.EmployeeDeleteView.as_view(),name="employee-remove"),
    path("employee/<int:pk>/update",views.EmployeeUpdate.as_view(),name="employee-update"),
    path("employee/<int:pk>/details",views.EmployeeDetailView.as_view(),name="employee-detail"),
